...
class CustomerUserRequestValidation {
    ...
    // validateGetSumGroupByField = () => {
    //     const schema = Joi.object({
    //         sumField: Joi.string().required(),
    //         groupByField: Joi.string().required(),
    //         groupByValue: Joi.string().alphanum().min(5).max(15).required(),
    //     });
    // }
}
